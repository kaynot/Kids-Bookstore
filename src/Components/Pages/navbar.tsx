...
<div className='w-[5%] cursor-pointer ' >
  ...
  <input type='text' placeholder='Search Book' className='border-2 border-black w-[50%] shadow-lg rounded-md p-2'/> 
  <div  className='p-2 rounded-2xl absolute w-[5%] cursor-pointer '>
    <img src={search} alt='search' className='w-[80%] h-[100%]'/>
  </div>
  </div>
  
  <ul className='flex justify-end w-[70%] gap-10 mx-5 text-[18px]'>
